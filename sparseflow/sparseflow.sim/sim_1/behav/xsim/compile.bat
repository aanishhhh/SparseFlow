...
REM
REM Generated by Vivado on Fri Jun 26 12:29:01 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_sparseflow_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_sparseflow_top_vlog.prj -log xvlog.log
